...
sap.ui.core.mvc.Controller.extend("shell.app.local-dd3.NLTMI0.MEMORY_PROFILER.MEM_PROFILER.view.FuncArea", {
       ...
       */
       ...
       _oDialog: null,
       onInit: function() {
              console.log('in init platform controller');
...
//              platformChart.bindData('/odata/MEM_PROFILER.xsodata/PLATFORM_OVERVIEW');
              ...
              console.log('!!!!!!     FuncArea MODEL Binding')
              ...
              var microData = jQuery.ajax({
                  ...
                  success: function(data){
                	  console.log('success function result funcarea: '+ data);
