...
sap.ui.core.mvc.Controller.extend("shell.app.local-dd3.NLTMI0.MEMORY_PROFILER.MEM_PROFILER.view.Platform", {
...
//              platformChart.bindData('/odata/MEM_PROFILER.xsodata/PLATFORM_OVERVIEW');
              ...
              console.log('!!!!!!     PLATFORM MODEL Binding')
              ...
              var microData = jQuery.ajax({
                  ...
                  success: function(data){
                	  console.log('success function result platform: '+ data);
